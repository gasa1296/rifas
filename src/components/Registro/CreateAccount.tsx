      ...
      <section className="text-secondary row m-0   position-relative">
        <div className="col-md-8  col-12 mx-0 mx-md-auto mt-5 ">
          ...
          <p className="text-center text-CreateAccount mt-0 mx-md-5">
            Es necesario crear una cuenta para apoyar alguna rifa, donar un
            premio o si eres una asociación y quieres crear tus rifas.
          </p>
        </div>
        <div
          className=" col-md-8 bg-white  m-auto  col-12  justify-content-center  d-flex my-3 text-secondary shadow rounded  px-3 position-relative "
          style={{ maxWidth: "600px", width: "100%", zIndex: 5 }}
        >
          <div>
