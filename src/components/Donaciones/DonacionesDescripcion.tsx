...
export default function DonacionesDescripcion({ nextStep }: any) {
    ...
    const submitData = async (data: Profile) => {
        ...
        { label: "¿Cual es la descripcion de tu premio?*", name: "prize_description", required: true, type: "text" },
        { label: "¿Que categoria describe tu producto?*", name: "prize_description2", required: true, type: "select" },
            ...
            <section className='row m-0 my-3' >
                ...
                <div className='col-12 col-md-6 text-secondary mx-4 mx-md-0 '>
                    ...
                    <div className='d-flex justify-content-end w-75 mw-md-50 '>
                        <button className='btn btn-outline-secondary btn-sm w-50 fs-6  ' onClick={() => nextStep()} > Continuar</button>
                    </div>
                </div>
            </section>
