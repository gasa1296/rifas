        ...
        <section className=''>
            <div className='background-dashboard  d-block d-lg-flex justify-content-between align-items-center py-3 col-12 '>
                <div className=' d-block d-md-flex '>
                    ...
                    <p className='title-dashboard ms-3 '>Rifas</p>
                </div>
                <div className='d-flex justify-content-between align-items-center'>
                    <button className=' p-2 me-3 button-dashboard m-0 '><MdKeyboardArrowLeft />Mis asociaciones </button>
                    <button className='me-3 button-dashboard btn-pink m-0 p-2  '><AiFillDollarCircle size={20} className='mx-2' />Nueva Rifa </button>
                </div>

            </div>
            <div className='pt-3 background-dashboard mt-3 '>
                <div className='d-flex justify-content-between border-1   px-3 ' >
                    <h6>Fechas </h6>
