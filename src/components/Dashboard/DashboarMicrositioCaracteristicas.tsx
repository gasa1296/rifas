...
export default function DashboarMicrositioCaracteristicas({ handleChangeRaffle }: any) {
    ...
    return (
        <section className='px-4 py-3 container-cartera '>
            <h6 className='title-micrositio'>1. Información general de tu Asociación</h6>
