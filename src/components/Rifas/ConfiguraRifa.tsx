  ...
  return (
    <div className="mx-4 ">
      ...
      <div className="row ">
        ...
        <p className="text-secondary fs-5">
          2. Elige una causa o agrega una nueva
        </p>
        <div className="d-lg-flex col-12  m-auto mb-3 ">
          <button className="mx-2 btn btn-dark col-lg-6 col-12  ">
            Seleccionar una causa
          </button>
          <button
            className=" mx-2 btn btn-light border col-12 col-lg-6 mt-lg-0 mt-3"
            onClick={handleShowCause}
          >
            Agregar una causa
          </button>
        </div>
        <p className="text-secondary fs-5">
          3. Elige tu premio o agrega uno nuevo
        </p>
        <div className="d-lg-flex col-12 col-lg-12 m-auto mb-3 ">
          <button className=" mx-2 btn btn-dark col-lg-6 col-12 ">
            Seleccionar un premio
          </button>
          <button
            className="  mx-2 btn btn-light border col-12 col-lg-6 mt-lg-0 mt-3"
        ...
        <label className="text-secondary my-2 ">
          Monto a recaudar en pesos MXN
        </label>
        <input className="form-control   " type="text" placeholder="$" />
        <p className="text-secondary fs-6">
          Tu monto a recaudar tiene que ser mayor al valor del premio ($1,500)
          más tus gastos de recuperación. Te recomendamos un monto a recaudar
          de: $2,100.00
        </p>
        <label className="form-label fw-bold">
          Selecciona el número de boletos para tu rifa
        </label>
        <input
          type="range"
