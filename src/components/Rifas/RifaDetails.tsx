...
export default function RifaDetails() {
    ...
    return (
        <section className='mx-3 mx-lg-5 py-3'>
            ...
            <h3 className="  mt-5 mt-md-3 title-RifaDetails">¡Hola! ¡Soy Emiliano, ayúdame a vencer el cáncer!</h3>
            <p className=" mt-2 mb-3  subtitle-RifaDetails col-6 ">Puebla, México — Necesitamos recaudar aproximadamente 150 mil pesos para cubrir los costos de la operación de Emiliano </p>
