...
export default function ModalInformationPremio({ setShowScreenInformationPremio, showScreenInformationPremio, handleCloseModalInformation }: any) {
    ...
    return (
        <>
            {showScreenInformationPremio

                ? <div className=''>
                    <Modal className="custom-modal" show={showScreenInformationPremio} setShowScreen={handleCloseModalInformation} >
                        <Modal.Body className="px-4">
                            ...
                            <div className='d-flex align-items-center m-0 '>
                                <p className='title-informationCausa'>Fecha en que se agrego: </p>
                            ...
                            <div className='d-flex align-items-center m-0 p-0' >
                                ...
                                <p className='mx-2 information-cause'>Tu rifa esta en proceso de verificación.</p>
                            </div>
                        </Modal.Body>
                    </Modal>
                    ...
                    <div className="modal-footer">
                        <button onClick={handleCloseModalInformation} type="button" className="btn btn-border-pink" data-bs-dismiss="modal">Cerrar</button>
