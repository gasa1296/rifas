...
export default function ModalInformationCausa({ handleCloseModalInformation, setShowScreenInformationCausa, showScreenInformationCausa }: any) {
    ...
    return (
        <>
            {showScreenInformationCausa

                ? <div className=''>
                    <Modal className="custom-modal" show={showScreenInformationCausa} setShowScreen={handleCloseModalInformation} >
