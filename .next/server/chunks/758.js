...
function InputFile({ label , name , error , setValue , maxFile , subLabel  }) {
    ...
    const onChangeFile = (event)=>{
        ...
        if (files?.length === MAX_UPLOAD_ITEMS) {
            react_hot_toast__WEBPACK_IMPORTED_MODULE_3__.toast.error(`Solo puedes subir ${MAX_UPLOAD_ITEMS} fotos por producto`);
            return;
        }
...
function InputText({ register , label , name , required , error , subLabel  }) {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("label", {
                className: `${error && "text-danger"} title-form-generator`,
...
function InputTitle({ register , label , name , required , error  }) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
            className: " text-dark fw-medium fs-3",
            children: label
        })
    });
}
...
/* harmony export */   "O": () => (/* binding */ getDefaultValues)
/* harmony export */ });
...
function FormGenerator({ fields , submitData , buttonText ="Enviar" , loading =false , renderButton  }) {
    const { handleSubmit , register , formState: { errors  } , setValue , watch  } = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_2__.useForm)({
        defaultValues: (0,_helper__WEBPACK_IMPORTED_MODULE_3__/* .getDefaultValues */ .O)(fields)
    });
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        const timeoutId = setTimeout(()=>{
            if (router?.query?.validateAccount) {
                postValidateAccount(router?.query?.validateAccount);
                handleShow();
            }
        }, 200);
...
function ModalProfile({ showprofile , setShowProfile  }) {
    ...
    const authOptions = [
        {
            label: "Cerrar sesion",
            path: "/",
            onClick: ()=>dispatch((0,_store_slices_auth__WEBPACK_IMPORTED_MODULE_2__/* .setLogout */ .wt)())
        },
        {
            label: "Profile",
            path: "/",
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: showprofile && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            className: "container-Profile me-1 rounded-3 shadow p-2",
...
const ForgotPasswordStore = (0,zustand__WEBPACK_IMPORTED_MODULE_1__.create)((set)=>({
        ...
        postValidateAccount: async (code)=>{
            try {
                ...
                await (0,_services_auth__WEBPACK_IMPORTED_MODULE_0__/* .postValidateAccount */ .iz)(code);
                set({
                    isLoading: false
                });
                return true;
